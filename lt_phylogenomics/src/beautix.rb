...
# If the specified analyses id is one of the b1..b9 series, ignore all other specified options and set these.
if ["b1", "b2", "b3"].include?(analysis_id)
    plus_gamma = true
    tree_model = "birthdeath"
    ucln_clock = true
    run_length = 5000000
    store_length = run_length/2000
end
