...
for group in pseudocrenilabrini astatotilapini bathybatini benthochromini cyphotilapiini cyprichromini ectodini1 ectodini2 eretmodini lamprologini1 lamprologini2 lamprologini3 lamprologini4 lamprologini5 limnochromini orthochromini perissodini serranochromini trematocarini tropheini1 tropheini2
do
    for method in astral raxml free
    do
