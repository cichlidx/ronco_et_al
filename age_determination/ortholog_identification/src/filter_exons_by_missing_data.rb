# m_matschiner Sun Mar 19 13:37:00 CET 2017
...
filenames_in.each do |f|
	...
	if missing_seqs <= maximum_number_of_missing_sequences and fasta_seqs[0].size >= minimum_alignment_length
...
# Feedback.
puts "#{n_files_written} out of #{filenames_in.size} exons remain after filtering."
